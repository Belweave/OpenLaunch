...
# IMPORTANT: If you change the embedding model (sentence-transformers/all-MiniLM-L6-v2) and vice versa, you aren't able to use RAG Chat with your previous documents loaded in the OpenLaunch! You need to re-embed them.
...
# The production bundle exceeds V8's default ~2 GiB heap inside Docker.
...
ARG BUILD_HASH
ENV OPENLAUNCH_BUILD_VERSION=${BUILD_HASH}
ENV DOCKER=true

...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by OpenLaunch users.
...
For immediate concerns or detailed reports that meet our guidelines, please create an issue in the [OpenLaunch issue tracker](https://github.com/belweave/openlaunch/issues).

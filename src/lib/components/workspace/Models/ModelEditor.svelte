<script lang="ts">
	...
	import { OPENLAUNCH_BASE_URL, DEFAULT_CAPABILITIES } from '$lib/constants';
	...
	let info = {
		...
		name: '',
		meta: {
			profile_image_url: `${OPENLAUNCH_BASE_URL}/static/favicon.png`,
			description: '',
						...
						<div class="self-start flex justify-center my-2 shrink-0">
							<div class="self-center">
								<button
									...
									`${OPENLAUNCH_BASE_URL}/static/favicon.png`
										? 'bg-transparent'
								...
								<div class="flex w-full mt-1 justify-end">
									<button
										...
										on:click={() => {
											info.meta.profile_image_url = `${OPENLAUNCH_BASE_URL}/static/favicon.png`;
										}}
										type="button"
									>

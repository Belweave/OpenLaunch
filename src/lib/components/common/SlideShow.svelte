<script lang="ts">
	...
	export let imageUrls = [
		`${OPENLAUNCH_BASE_URL}/assets/images/adam.jpg`,
		`${OPENLAUNCH_BASE_URL}/assets/images/galaxy.jpg`,
		`${OPENLAUNCH_BASE_URL}/assets/images/earth.jpg`,
		`${OPENLAUNCH_BASE_URL}/assets/images/space.jpg`
	];

				...
				{:else}
					<div
						class=" {rmsLevel * 100 > 4
							...
							?.profile_image_url ?? '/static/openlaunch_logo.png') !== '/static/openlaunch_logo.png'
							? ' bg-cover bg-center bg-no-repeat'
							: 'bg-black dark:bg-white'}  bg-black dark:bg-white"
						style={(model?.info?.meta?.profile_image_url ?? '/static/openlaunch_logo.png') !==
						'/static/openlaunch_logo.png'

...
export const getConfig = async (token: string = '') => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/evaluations/config`, {
		method: 'GET',
		headers: {
...
export const getLeaderboard = async (token: string = '', query: string = '') => {
	...
	const res = await fetch(
		`${OPENLAUNCH_API_BASE_URL}/evaluations/leaderboard?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const getModelHistory = async (token: string = '', modelId: string, days: number = 30) => {
	...
	const res = await fetch(
		`${OPENLAUNCH_API_BASE_URL}/evaluations/leaderboard/${encodeURIComponent(modelId)}/history?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const getFeedbackModelIds = async (token: string = '') => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/evaluations/feedbacks/models`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getFeedbackItems = async (
	...
	const res = await fetch(
		`${OPENLAUNCH_API_BASE_URL}/evaluations/feedbacks/list?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const exportAllFeedbacks = async (token: string = '', modelId: string = '') => {
	...
	const res = await fetch(
		`${OPENLAUNCH_API_BASE_URL}/evaluations/feedbacks/all/export?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const createNewFeedback = async (token: string, feedback: object) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/evaluations/feedback`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getFeedbackById = async (token: string, feedbackId: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/evaluations/feedback/${feedbackId}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',

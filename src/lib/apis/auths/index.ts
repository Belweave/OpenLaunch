...
export const getAdminDetails = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/admin/details`, {
		method: 'GET',
		headers: {
...
export const getAdminConfig = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/admin/config`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getSessionUser = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const ldapUserSignIn = async (user: string, password: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/ldap`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
...
export const getLdapConfig = async (token: string = '') => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/admin/config/ldap`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
...
export const getLdapServer = async (token: string = '') => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/admin/config/ldap/server`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			...(token && { authorization: `Bearer ${token}` })
...
export const getOAuthConfig = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/admin/config/oauth`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const userSignIn = async (email: string, password: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/signin`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
...
export const userSignUp = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/signup`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
...
export const userSignOut = async () => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/signout`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
...
export const addUser = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/add`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			...(token && { authorization: `Bearer ${token}` })
...
export const updateUserProfile = async (token: string, profile: object) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/update/profile`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			...(token && { authorization: `Bearer ${token}` })
...
export const updateUserTimezone = async (token: string, timezone: string) => {
	await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/update/timezone`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			...(token && { authorization: `Bearer ${token}` })
...
export const updateUserPassword = async (token: string, password: string, newPassword: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/update/password`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			...(token && { authorization: `Bearer ${token}` })
...
export const createAPIKey = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/auths/api_key`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const deleteOAuthSession = async (token: string, provider: string) => {
	...
	const res = await fetch(
		`${OPENLAUNCH_API_BASE_URL}/auths/oauth/sessions/${encodeURIComponent(provider)}`,
		{
			method: 'DELETE',
			headers: {
				'Content-Type': 'application/json',

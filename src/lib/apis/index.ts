...
export const getModels = async (
	...
	const res = await fetch(
		`${OPENLAUNCH_BASE_URL}/api/models${base ? '/base' : ''}?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
...
export const unloadModel = async (token: string, model: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/models/unload`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const chatCompleted = async (token: string, body: ChatCompletedForm) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/chat/completed`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const chatAction = async (token: string, action_id: string, body: ChatActionForm) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/chat/actions/${action_id}`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const stopTask = async (token: string, id: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/tasks/stop/${id}`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const stopTasksByChatId = async (token: string, chat_id: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/tasks/chat/${encodeURIComponent(chat_id)}/stop`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getTaskIdsByChatId = async (token: string, chat_id: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/tasks/chat/${encodeURIComponent(chat_id)}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getTaskConfig = async (token: string = '') => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/tasks/config`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateTaskConfig = async (token: string, config: object) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/tasks/config/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generateTitle = async (
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/tasks/title/completions`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generateTags = async (
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/tasks/tags/completions`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generateEmoji = async (
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/tasks/emoji/completions`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generateQueries = async (
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/tasks/queries/completions`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generateAutoCompletion = async (
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/tasks/auto/completions`, {
...
export const generateMoACompletion = async (
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/tasks/moa/completions`, {
		signal: controller.signal,
		method: 'POST',
		headers: {
			Accept: 'application/json',
...
export const getPipelinesList = async (token: string = '') => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/pipelines/list`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const uploadPipeline = async (token: string, file: File, urlIdx: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/pipelines/upload`, {
		method: 'POST',
		headers: {
			...(token && { authorization: `Bearer ${token}` })
...
export const downloadPipeline = async (token: string, url: string, urlIdx: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/pipelines/add`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deletePipeline = async (token: string, id: string, urlIdx: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/pipelines/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getPipelines = async (token: string, urlIdx?: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/v1/pipelines/?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getPipelineValves = async (token: string, pipeline_id: string, urlIdx: string) => {
	...
	const res = await fetch(
		`${OPENLAUNCH_BASE_URL}/api/v1/pipelines/${pipeline_id}/valves?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const getPipelineValvesSpec = async (token: string, pipeline_id: string, urlIdx: string) => {
	...
	const res = await fetch(
		`${OPENLAUNCH_BASE_URL}/api/v1/pipelines/${pipeline_id}/valves/spec?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const updatePipelineValves = async (
	...
	const res = await fetch(
		`${OPENLAUNCH_BASE_URL}/api/v1/pipelines/${pipeline_id}/valves/update?${searchParams.toString()}`,
		{
			method: 'POST',
			headers: {
				Accept: 'application/json',
...
export const getUsage = async (token: string = '') => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/usage`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			...(token && { Authorization: `Bearer ${token}` })
...
export const getBackendConfig = async () => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/config`, {
		method: 'GET',
		credentials: 'include',
		headers: {
			'Content-Type': 'application/json'
	...
	if (error) {
		...
		if (error instanceof TypeError) {
			try {
				const probeRes = await fetch(`${OPENLAUNCH_BASE_URL}/api/config`, {
					method: 'GET',
					credentials: 'include',
					redirect: 'manual',
...
export const getChangelog = async () => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/changelog`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json'
		}
...
export const getVersion = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/version`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getVersionUpdates = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/version/updates`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getEvents = async (
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/events`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getEventWebhooks = async (token: string): Promise<EventWebhook[]> => {
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/events/webhooks`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const updateEventWebhook = async (
	...
	const res = await fetch(`${OPENLAUNCH_BASE_URL}/api/events/webhooks/${id}`, {
		method: 'PUT',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`

...
export const importConfig = async (token: string, config: object) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/import`, {
		method: 'POST',
		headers: {
...
export const exportConfig = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/export`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getConnectionsConfig = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/connections`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getToolServerConnections = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/tool_servers`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getTerminalServerConnections = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/terminal_servers`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
 ...
 * Proxied through the OpenLaunch backend to keep API keys server-side.
 */
export const putOrchestratorPolicy = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/terminal_servers/policy`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const putOrchestratorLifecycle = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/terminal_servers/lifecycle`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const refreshOrchestratorTerminals = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/terminal_servers/refresh`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const verifyTerminalServerConnection = async (token: string, connection: object) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/terminal_servers/verify`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const verifyToolServerConnection = async (token: string, connection: object) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/tool_servers/verify`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const registerOAuthClient = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/oauth/clients/register${searchParams}`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getOAuthClientAuthorizationUrl = (clientId: string, type: null | string = null) => {
	...
	return `${OPENLAUNCH_BASE_URL}/oauth/clients/${oauthClientId}/authorize`;
};
...
export const getCodeExecutionConfig = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/code_execution`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getModelsDefaults = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/models/defaults`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getModelsConfig = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/models`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const setDefaultPromptSuggestions = async (token: string, promptSuggestions: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/suggestions`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getBanners = async (token: string): Promise<Banner[]> => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/configs/banners`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`

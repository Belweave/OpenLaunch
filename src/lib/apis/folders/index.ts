...
export const createNewFolder = async (token: string, folderForm: FolderForm) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/folders/`, {
		method: 'POST',
		headers: {
...
export const getFolderById = async (token: string, id: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/folders/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFolderById = async (token: string, id: string, folderForm: FolderForm) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/folders/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFolderIsExpandedById = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/folders/${id}/update/expanded`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFolderParentIdById = async (token: string, id: string, parentId?: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/folders/${id}/update/parent`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteFolderById = async (token: string, id: string, deleteContents: boolean) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/folders/${id}?${searchParams.toString()}`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFolderAccessById = async (token: string, id: string, accessGrants: any[]) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/folders/${id}/access/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getSharedFolders = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/folders/shared`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getSharedFolderChats = async (token: string, folderId: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/folders/${folderId}/shared/chats`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',

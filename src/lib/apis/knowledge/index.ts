...
export const createNewKnowledge = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/create`, {
		method: 'POST',
		headers: {
...
export const getExternalKnowledgeConnections = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/external/connections`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateExternalKnowledgeConnection = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/external/connections/${id}`, {
		method: 'PATCH',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const testExternalKnowledgeConnection = async (token: string, id: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/external/connections/${id}/test`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const testExternalKnowledgeRetrieval = async (
	...
	const res = await fetch(
		`${OPENLAUNCH_API_BASE_URL}/knowledge/external/connections/${id}/retrieve-test`,
		{
			method: 'POST',
			headers: {
				Accept: 'application/json',
...
export const testExternalKnowledgeSource = async (token: string, payload: object) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/external/source/test`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const createExternalKnowledgeSource = async (token: string, payload: object) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/external/source/create`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateExternalKnowledgeSource = async (token: string, id: string, payload: object) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/external/source/${id}`, {
		method: 'PATCH',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const createExternalKnowledge = async (token: string, payload: object) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/external/knowledge/create`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getKnowledgeBases = async (token: string = '', page: number | null = null) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const searchKnowledgeBases = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/search?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const searchKnowledgeFiles = async (
	...
	const res = await fetch(
		`${OPENLAUNCH_API_BASE_URL}/knowledge/search/files?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const getKnowledgeById = async (token: string, id: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const searchKnowledgeFilesById = async (
	...
	const res = await fetch(
		`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/files?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const getPendingKnowledgeFiles = async (token: string, id: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/files/pending`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const streamPendingKnowledgeFiles = async (token: string, id: string) => {
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/files/pending?stream=true`, {
		method: 'GET',
		headers: {
...
export const updateKnowledgeById = async (token: string, id: string, form: KnowledgeUpdateForm) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateKnowledgeAccessGrants = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/access/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const addFileToKnowledgeById = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/file/add`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFileFromKnowledgeById = async (token: string, id: string, fileId: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/file/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const removeFileFromKnowledgeById = async (token: string, id: string, fileId: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/file/remove`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const resetKnowledgeById = async (token: string, id: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/reset`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const syncKnowledgeDiff = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/sync/diff`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const syncKnowledgeCleanup = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/sync/cleanup`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteKnowledgeById = async (token: string, id: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const reindexKnowledgeFiles = async (token: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/reindex`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const exportKnowledgeById = async (token: string, id: string) => {
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/export`, {
		method: 'GET',
		headers: {
			authorization: `Bearer ${token}`
		}
...
export const createKnowledgeDirectory = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/dirs/create`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateKnowledgeDirectory = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/dirs/${dirId}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteKnowledgeDirectory = async (
	...
	const res = await fetch(
		`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/dirs/${dirId}/delete?${searchParams.toString()}`,
		{
			method: 'DELETE',
			headers: {
				Accept: 'application/json',
...
export const moveFileInKnowledge = async (
	...
	const res = await fetch(`${OPENLAUNCH_API_BASE_URL}/knowledge/${id}/file/move`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',

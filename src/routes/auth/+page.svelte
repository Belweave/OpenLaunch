	...
	async function setLogoImage() {
		...
		if (logo) {
			...
			if (isDarkMode) {
				...
				darkImage.src = `${OPENLAUNCH_BASE_URL}/static/favicon-dark.png`;

				darkImage.onload = () => {
					logo.src = `${OPENLAUNCH_BASE_URL}/static/favicon-dark.png`;
	...
	onMount(async () => {
		...
		if ($config?.oauth?.auto_redirect && !form && !error) {
			...
			if (
				...
				window.location.href = `${OPENLAUNCH_BASE_URL}/oauth/${providers[0]}/login`;
				return;
			}
		}
								...
								<div class="flex flex-col space-y-2">
									{#if $config?.oauth?.providers?.google}
										<button
											...
											on:click={() => {
												window.location.href = `${OPENLAUNCH_BASE_URL}/oauth/google/login`;
											}}
										>
											<svg
									...
									{#if $config?.oauth?.providers?.microsoft}
										<button
											class="flex justify-center items-center bg-gray-700/5 hover:bg-gray-700/10 dark:bg-gray-100/5 dark:hover:bg-gray-100/10 dark:text-gray-300 dark:hover:text-white transition w-full rounded-full font-medium text-sm py-2.5"
											on:click={() => {
												window.location.href = `${OPENLAUNCH_BASE_URL}/oauth/microsoft/login`;
											}}
										>
											<svg
												xmlns="http://www.w3.org/2000/svg"
									...
									{#if $config?.oauth?.providers?.github}
										<button
											class="flex justify-center items-center bg-gray-700/5 hover:bg-gray-700/10 dark:bg-gray-100/5 dark:hover:bg-gray-100/10 dark:text-gray-300 dark:hover:text-white transition w-full rounded-full font-medium text-sm py-2.5"
											on:click={() => {
												window.location.href = `${OPENLAUNCH_BASE_URL}/oauth/github/login`;
											}}
										>
											<svg
												xmlns="http://www.w3.org/2000/svg"
									...
									{#if $config?.oauth?.providers?.oidc}
										<button
											class="flex justify-center items-center bg-gray-700/5 hover:bg-gray-700/10 dark:bg-gray-100/5 dark:hover:bg-gray-100/10 dark:text-gray-300 dark:hover:text-white transition w-full rounded-full font-medium text-sm py-2.5"
											on:click={() => {
												window.location.href = `${OPENLAUNCH_BASE_URL}/oauth/oidc/login`;
											}}
										>
											<svg
												xmlns="http://www.w3.org/2000/svg"
									...
									{#if $config?.oauth?.providers?.feishu}
										<button
											class="flex justify-center items-center bg-gray-700/5 hover:bg-gray-700/10 dark:bg-gray-100/5 dark:hover:bg-gray-100/10 dark:text-gray-300 dark:hover:text-white transition w-full rounded-full font-medium text-sm py-2.5"
											on:click={() => {
												window.location.href = `${OPENLAUNCH_BASE_URL}/oauth/feishu/login`;
											}}
										>

...
from openlaunch.env import DATABASE_USER_ACTIVE_STATUS_UPDATE_INTERVAL
from openlaunch.internal.db import Base, JSONField, get_async_db_context
from openlaunch.utils.misc import throttle
...
class UsersTable:
    ...
    async def get_users(
        ...
        async with get_async_db_context(db) as session:
            ...
            from openlaunch.models.channels import ChannelMember
            from openlaunch.models.groups import GroupMember

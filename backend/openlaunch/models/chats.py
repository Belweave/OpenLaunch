...
# local imports
from openlaunch.internal.db import Base, JSONField, get_async_db_context
from openlaunch.models.automations import AutomationRun
from openlaunch.models.chat_messages import ChatMessage, ChatMessages
from openlaunch.models.folders import Folders
from openlaunch.models.tags import Tag, TagModel, Tags
from openlaunch.utils.misc import sanitize_data_for_db, sanitize_text_for_db
...
class ChatTable:
    ...
    async def insert_shared_chat_by_chat_id(self, chat_id: str, db: AsyncSession | None = None) -> ChatModel | None:
        ...
        from openlaunch.models.shared_chats import SharedChats
    ...
    async def get_chats_by_model_id(
        ...
        from openlaunch.models.users import User
    ...
    async def delete_shared_chats_by_user_id(self, user_id: str, db: AsyncSession | None = None) -> bool:
        ...
        from openlaunch.models.shared_chats import SharedChat as SharedChatTable
        from openlaunch.models.shared_chats import SharedChats

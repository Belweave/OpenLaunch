...
from openlaunch.env import FORWARD_SESSION_INFO_HEADER_CHAT_ID
from openlaunch.retrieval.web.main import SearchResult, get_filtered_results
...
def search_external(
    ...
    try:
        headers = {
            'User-Agent': 'OpenLaunch (https://github.com/belweave/openlaunch) RAG Bot',

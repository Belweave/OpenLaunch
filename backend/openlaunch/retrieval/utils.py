...
from openlaunch.retrieval.vector.main import GetResult, SearchResult
...
from openlaunch.utils.misc import get_message_list
...
def build_loader_from_config(request, config: dict):
    ...
    from openlaunch.retrieval.loaders.main import Loader
...
def _get_content_from_url_sync(request, url: str, loader_config):
    from openlaunch.retrieval.web.utils import validate_url, _SSRFSafeAdapter
...
# Anything else cannot be a real OpenLaunch collection and could break out of

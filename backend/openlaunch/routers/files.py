...
from openlaunch.config import BYPASS_ADMIN_ACCESS_CONTROL, STORAGE_LOCAL_CACHE, STORAGE_PROVIDER, UPLOAD_DIR
from openlaunch.constants import ERROR_MESSAGES
from openlaunch.events import EVENTS, publish_event
from openlaunch.internal.db import get_async_db_context, get_async_session
...
from openlaunch.models.files import (
    FileForm,
    FileListResponse,
    FileModel,
    FileModelResponse,
...
from openlaunch.routers.audio import transcribe
from openlaunch.routers.retrieval import ProcessFileForm, process_file
from openlaunch.storage.provider import Storage
from openlaunch.utils.auth import get_admin_user, get_verified_user
from openlaunch.utils.misc import strict_match_mime_type
...
async def upload_file_handler(
    ...
    try:
        ...
        tags = {
            'OpenLaunch-User-Email': user.email,
            'OpenLaunch-User-Id': user.id,
            'OpenLaunch-User-Name': user.name,
            'OpenLaunch-File-Id': id,
        }
        try:

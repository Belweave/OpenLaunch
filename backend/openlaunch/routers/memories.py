...
from openlaunch.models.memories import Memories, MemoryModel
from openlaunch.retrieval.vector.async_client import ASYNC_VECTOR_DB_CLIENT
from openlaunch.config import RAG_EMBEDDING_QUERY_PREFIX
from openlaunch.utils.access_control import has_permission
from openlaunch.utils.auth import get_verified_user
from openlaunch.utils.memory import (
...
async def query_memory(
    ...
    if results and relevance_threshold > 0.0 and results.distances and results.distances[0]:
        from openlaunch.retrieval.vector.main import SearchResult

...
from openlaunch.models.functions import FunctionModel, Functions
...
def replace_imports(content):
    ...
    """
    replacements = {
        'from utils': 'from openlaunch.utils',
        'from apps': 'from openlaunch.apps',
        'from main': 'from openlaunch.main',
        'from config': 'from openlaunch.config',
    }

...
from openlaunch.utils.task import prompt_template, prompt_variables_template
...
def remove_openlaunch_params(params: dict) -> dict:
    """
    Removes OpenLaunch specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with OpenLaunch parameters removed.
    """
    openlaunch_params = {
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_openlaunch_params(params)

...
from openlaunch.models.auths import Auths
from openlaunch.models.config import Config
from openlaunch.models.groups import GroupForm, GroupModel, Groups, GroupUpdateForm
from openlaunch.models.oauth_sessions import OAuthSessions
from openlaunch.models.users import Users
from openlaunch.retrieval.web.utils import validate_url
from openlaunch.utils.auth import create_token, get_password_hash
from openlaunch.utils.groups import apply_default_group_assignment
from openlaunch.utils.misc import parse_duration
from openlaunch.utils.validate import validate_profile_image_url
...
from openlaunch.env import GLOBAL_LOG_LEVEL
...
async def get_oauth_client_info_with_dynamic_client_registration(
    ...
    try:
        ...
        redirect_base_url = (str(openlaunch_url or request.base_url)).rstrip('/')

        oauth_client_metadata = OAuthClientMetadata(
            client_name='OpenLaunch',
...
class OAuthClientManager:
    ...
    async def handle_callback(self, request, client_id: str, user_id: str, response):
        ...
        openlaunch_url = await Config.get('openlaunch.url')
        redirect_url = (str(openlaunch_url or request.base_url)).rstrip('/')
...
class OAuthManager:
    ...
    async def update_user_groups(self, user, user_data, default_permissions, db=None):
        ...
        log.debug(f'All groups available in OpenLaunch: {[g.name for g in all_available_groups]}')
